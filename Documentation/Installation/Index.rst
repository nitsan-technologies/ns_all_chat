...
#. Get the extension
   ...
   .. figure:: Images/TYPO3_Allchats_Extension_NITSAN_Backend_Install_Extensions.png
...
#. Activate the TypoScript
   ...
   #. Select **[NITSAN] ns_all_chat** at the field *Include static
      (from extensions):*

   #. Include **[NITSAN] ns_all_chat** at the last place.

   .. figure:: Images/TYPO3_Allchats_Extension_NITSAN_Backend_Include_Static_Template.png
       :alt: installation
       :width: 1100px
